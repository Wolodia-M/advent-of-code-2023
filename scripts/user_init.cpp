...
TODO todo35(35, "Do tasks 35 and 36.");
...
CBuild::GXX challenge41("challenge41");
TODO todo41(41, "Do tasks 41 and 42.");
CBuild::GXX challenge43("challenge43");
TODO todo43(43, "Do tasks 43 and 44.");
CBuild::GXX challenge45("challenge45");
CBuild::GXX challenge46("challenge46");
...
void init() {
  ...
  challenge40.add_requirment("TODO40");
  CBuild::Registry::RegisterTarget(&challenge40);
  CBuild::Registry::RegisterTask(&todo40);
  challenge41.add_folder("src/task41/");
  challenge41.set_standart("c++20");
  challenge41.add_link_arg("-lstdc++");
  challenge41.add_requirment("TODO41");
  CBuild::Registry::RegisterTarget(&challenge41);
  CBuild::Registry::RegisterTask(&todo41);
  challenge43.add_folder("src/task43/");
  challenge43.set_standart("c++20");
  challenge43.add_link_arg("-lstdc++");
  challenge43.add_requirment("TODO43");
  CBuild::Registry::RegisterTarget(&challenge43);
  CBuild::Registry::RegisterTask(&todo43);
  challenge45.add_folder("src/task45/");
  challenge45.set_standart("c++20");
  challenge45.add_link_arg("-lstdc++");
  CBuild::Registry::RegisterTarget(&challenge45);
  challenge46.add_folder("src/task46/");
  challenge46.set_standart("c++20");
  challenge46.add_link_arg("-lstdc++");
  CBuild::Registry::RegisterTarget(&challenge46);
}